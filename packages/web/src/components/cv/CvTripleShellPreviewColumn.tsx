    ...
    return (
      <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden bg-[#080B0B] max-lg:min-h-[calc(100dvh-3.5rem)]">
        ...
        <div
          ...
          className="app-scrollbar flex min-h-0 flex-1 justify-center overflow-y-auto overflow-x-hidden [-webkit-overflow-scrolling:touch] touch-pan-y overscroll-y-contain px-0 pb-2 pt-0 max-lg:justify-start max-lg:px-0 max-lg:pb-1 max-lg:pt-0"
        >
